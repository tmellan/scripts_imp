...
s=0
#reciprocal of 11 configs is 0.09090909 for taking the average over the configs number for each lambda
...
###########MAKE SURE THE AVERAGE IS ADJUSTED FOR THE NUMBER OF LAMBDAS
    awk '{ $3 = 0.09090909*$1-$2 } 1' $dir/$k/UP-SAMPLE/lambda$j/high_and_perf > $dir/$k/UP-SAMPLE/lambda$j/high_minus_perf_av
